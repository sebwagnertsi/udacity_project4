...
def clean_data():
    ...
    pd.DataFrame(X).to_csv(
        Config.data_preprocessed_path+'/_X.csv', index=False)
    pd.DataFrame(y).to_csv(
        Config.data_preprocessed_path+'/_y.csv', index=False)
    ...
    # Save all the X and y values:
    pd.DataFrame(X).to_csv(Config.data_preprocessed_path +
                           '/_validation_X.csv', index=False)
    pd.DataFrame(y).to_csv(Config.data_preprocessed_path +
                           '/_validation_y.csv', index=False)
